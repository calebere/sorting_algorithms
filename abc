...
void heap_sort(int *array, size_t size)
{
	...
	for (i = size / 2 - 1; i >= 0; i--)
		max_heapify(array, size, (size_t)i, size);
	...
	for (i = size - 1; i >= 0; i--)
	{
		...
		max_heapify(array, (size_t)i, 0, size);
	}
}
 ...
 */
void max_heapify(int *array, size_t s, size_t root, size_t size)
{
